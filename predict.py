...
if __name__ == "__main__":
	for mk_ride in ["7_dwarfs_train", "pirates_of_caribbean"]:
		...
		predict_wait_times(mk_ride, scalers, "3/10/2024", 8, 23)
		predict_wait_times(mk_ride, scalers, "3/11/2024", 8, 23)
		predict_wait_times(mk_ride, scalers, "3/12/2024", 8, 23)
		predict_wait_times(mk_ride, scalers, "3/13/2024", 8, 24)
		predict_wait_times(mk_ride, scalers, "3/14/2024", 8, 23)
		predict_wait_times(mk_ride, scalers, "3/15/2024", 8, 23)
	for ep_ride in ["soarin", "spaceship_earth"]:
		scalers = ml_helper.fit_wait_times(ep_ride)
		predict_wait_times(ep_ride, scalers, "3/10/2024", 9, 21)
		predict_wait_times(ep_ride, scalers, "3/11/2024", 9, 23)
		predict_wait_times(ep_ride, scalers, "3/12/2024", 9, 21)
		predict_wait_times(ep_ride, scalers, "3/13/2024", 9, 21)
		predict_wait_times(ep_ride, scalers, "3/14/2024", 9, 21)
		predict_wait_times(ep_ride, scalers, "3/15/2024", 9, 21)
	for hs_ride in ["alien_saucers", "toy_story_mania", "slinky_dog"]:
		scalers = ml_helper.fit_wait_times(hs_ride)
		predict_wait_times(hs_ride, scalers, "3/10/2024", 8, 21)
		predict_wait_times(hs_ride, scalers, "3/11/2024", 8, 21)
		predict_wait_times(hs_ride, scalers, "3/12/2024", 8, 21)
		predict_wait_times(hs_ride, scalers, "3/13/2024", 8, 21)
		predict_wait_times(hs_ride, scalers, "3/14/2024", 8, 21)
		predict_wait_times(hs_ride, scalers, "3/15/2024", 8, 21)
	for ak_ride in ["dinosaur", "expedition_everest", "flight_of_passage", "kilimanjaro_safaris", "navi_river"]:
		...
		predict_wait_times(ak_ride, scalers, "3/10/2024", 8, 20)
		predict_wait_times(ak_ride, scalers, "3/11/2024", 8, 20)
		predict_wait_times(ak_ride, scalers, "3/12/2024", 8, 20)
		predict_wait_times(ak_ride, scalers, "3/13/2024", 7, 20)
		predict_wait_times(ak_ride, scalers, "3/14/2024", 7, 20)
		predict_wait_times(ak_ride, scalers, "3/15/2024", 8, 20)
